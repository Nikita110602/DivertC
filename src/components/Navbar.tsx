...
<nav className="bg-white border-gray-200 dark:bg-gray-900 fixed w-full z-20 top-0 start-0">
  ...
  <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
      <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white font-mono"><mark className="px-2 py-1 text-white bg-blue-600 rounded dark:bg-blue-500 mr-1">Divert&#60;&#47;&#62;</mark>code</span>
  </a>
